...
std::vector<uint32_t> parallel_scan(const std::vector<uint32_t> & data, std::size_t& lastVal){//exclusive_inplace
    ...
    std::vector<uint32_t> result (result_size);// power of 2
